// Trigger PIN connected to GPIO0 (D3) of ESP8266 ESP-01S module
// ECHO PIN of ultrasonic sensor connected to GPIO2 (D4)
...
const char *topic_pub_state = "customer_detector/exchanges/customer_detector_0001/state";
const char *topic_pub_event = "customer_detector/exchanges/customer_detector_0001/events";
const char *topic_sub1 = "customer_detector/exchanges/customer_detector_0001/ctl";

const char *ssid =  "TP-Link_65D4";  // Имя вайфай точки доступа
const char *pass =  "27348727"; // Пароль от точки доступа
...
const char *mqtt_device_id = "customer_detector_0001";
